...
model.p + 
  geom_point(aes(x = gdpPercap, y = lifeExp, colour = continent)) + 
  geom_smooth(aes(x = m.x, y = m.y, xend = 1800, yend = 100))

#Turns out people aren't exactly like enzyme kinetics...hmmm. 
#My major assumption is human age maxes out at some point here. 
#Seems more like two intersecting lines to me now....
```
...
_In the future, I will want to see if I can bin countries by correlation between gdpPercap v. lifeExp_
