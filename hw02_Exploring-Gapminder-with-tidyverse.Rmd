...
model.p <- gapminder %>% 
  ggplot()
model.p + geom_point(aes(x = gdpPercap, y = lifeExp, colour = continent)) + geom_smooth(aes(x = x, y = m.y, xend = 1800, yend = 100))
...
Seems like the continents populate this plot differently.
